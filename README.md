...
Version 0.2.1 implements the Folsom reference workflow as an adjustable,
...
1. Use the release archive `Skin_and_Bones_Forge_v0.2.1.zip`.
...
The successful run exposes `Skin_and_Bones_Forge_v0.2.1` under **Artifacts**
