...
Version 1.0.2 implements one-click SPAR3D production-mesh intake, the Folsom
...
1. Use the release archive `Skin_and_Bones_Forge_v1.0.2.zip`.
...
The successful run exposes `Skin_and_Bones_Forge_v1.0.2` under **Artifacts**
...
Version 1.0.2 completes the simplified-hand production contract and permanent
